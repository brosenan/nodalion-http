...
var nodalion = new Nodalion(Nodalion.__dirname + '/prolog/cedalion.pl', '/tmp/http.log');
...
describe('http', function(){
	...
	var builtin = Nodalion.namespace('builtin', ['succ']);
	var res = yield nodalion.findAll({var:'X'}, impred.pred(builtin.succ(1, {var:'X'})), $R());
	assert.equal(res, 2);
    }));
